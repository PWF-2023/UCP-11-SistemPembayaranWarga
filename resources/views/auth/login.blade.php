    ...
    <form method="POST" action="{{ route('login') }}" novalidate>
        @csrf
            ...
            <div class="flex justify-center py-2">
                ...
                <button aria-label="Log in with GitHub" class="inline-flex items-center px-4 py-2 text-gray-900 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-5 h-5 fill-current">
            ...
            <div class="flex items-center justify-center">
                ...
                <a rel="noopener noreferrer" href="{{ route('register') }}" class="text-sm ml-2 font-semibold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">Sign up</a>
            </div>
